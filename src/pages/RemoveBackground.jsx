            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="w-full flex justify-center items-center gap-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-white border border-gray-200 dark:border-slate-700 px-4 py-2.5 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-all font-medium shadow-sm active:scale-95"
                >
